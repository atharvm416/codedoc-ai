"""0.12.1 — structured response diagnostics and the canonical response path.

Covers the extraction outcomes, the top-level rejection precedence, the per-field
removal reason codes reported by the cleaner reporters, the declared hard caps,
and the sanitization guarantee that no raw response text reaches a diagnostic.
"""
...
# ---------------------------------------------------------------------------
# process_response top-level reasons and stages
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Per-field removal reason codes (via the reporter)
# ---------------------------------------------------------------------------
