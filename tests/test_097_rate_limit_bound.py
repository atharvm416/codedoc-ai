...
def test_persistent_rate_limit_stops_after_bounded_passes(
    ...
    # Every stop is safe: the live JSON backup is intact and resumable, never
    # deleted or overwritten with a "complete" final output.
    backup = tmp_path / "docs" / "codedoc.json"
