"""
0.8.1 — Placeholder usage-example sanitization tests (Workstream B).

Plan acceptance criteria:
  B1  New generated record with a ``your_package`` usage example is sanitized.
  B2  New generated record with ``your_project``, ``your_app``,
      ``your_package_name``, ``example_package``, and ``my_package`` are each
      sanitized.
  B3  Dart-style ``package:example/`` placeholder is sanitized.
  B4  Reused / cached record whose usage_example contains a placeholder is
      sanitized before final output.
  B5  Valid examples with real package names or relative imports are NOT removed.
  B6  Word-boundary check: a real path that merely contains the word ``example``
      as part of a longer compound identifier is NOT treated as a placeholder.
  B7  Case-insensitive matching (YOUR_PACKAGE, Your_Package, etc.).
  B8  Empty or missing usage_example is left unchanged (no crash).
  B9  Sanitization is idempotent — running _clean_file twice gives the same result.
  B10 Sanitized records survive the Markdown → embedded view → JSON round-trip.
  B11 Pipeline-produced JSON and Markdown have no placeholder in usage_example.
"""
...
# ---------------------------------------------------------------------------
# B2 — each remaining placeholder word
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B3 — Dart package:example/ placeholder
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B4 — Reused / cached records are sanitized
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B5 — Real package names / relative imports are preserved
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B6 — Word-boundary: compound identifiers containing placeholder words
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B8 — Empty / missing usage_example left unchanged
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B10 — Sanitized records survive the Markdown round-trip
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# B11 — Pipeline-produced output has no placeholder
# ---------------------------------------------------------------------------
